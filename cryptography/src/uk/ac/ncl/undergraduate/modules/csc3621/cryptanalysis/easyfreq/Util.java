...
public class Util {
	 ...
	 * @throws IOException
	 *             something goes wrong creating the file and/or reading from it
	 */
	 ...
	 *            the file path
	 * @throws IOException
	 *             something goes wrong creating the file and/or writing
	 */
	...
	/**
	 * Perform modulo operation on two integers. Allows for negative numbers.
	 * 
	 * @param x
	 * @param y
	 * @return result
	...
	public static int countLetters(String text) {
		...
		for (int i = 0; i < text.length(); i++) {
			...
			if (isValidLetter(text.charAt(i)))
				count++;
		}
